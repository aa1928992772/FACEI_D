...
public class MainActivity2 extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.listview_main).setVisibility(View.GONE);
		Intent intent = null;
		intent = new Intent(MainActivity2.this,OnlineFaceDemo.class);
	...
	public void onClick(View view) {
		...
		case 0:
			// 语音转写
			intent = new Intent(MainActivity2.this, IatDemo.class);
			break;
		case 1:
			// 语法识别
			intent = new Intent(MainActivity2.this, AsrDemo.class);
			break;
		case 2:
			// 语义理解
		...
		case 3:
			// 语音合成
			intent = new Intent(MainActivity2.this, TtsDemo.class);
			break;
		case 4:
			// 语音评测
			intent = new Intent(MainActivity2.this, IseDemo.class);
			break;
		case 5:
			// 唤醒
		...
		case 6:
			// 声纹
			intent = new Intent(MainActivity2.this, VocalVerifyDemo.class);
			break;
		case 7:
			intent = new Intent(MainActivity2.this,OnlineFaceDemo.class);
			break;
	...
	protected void onResume() {
		// 开放统计 移动数据统计分析
		FlowerCollector.onResume(MainActivity2.this);
	...
	protected void onPause() {
		...
		FlowerCollector.onPause(MainActivity2.this);
		super.onPause();
	}
