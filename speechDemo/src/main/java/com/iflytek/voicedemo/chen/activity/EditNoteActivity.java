package com.iflytek.voicedemo.chen.activity;
...
import com.iflytek.voicedemo.chen.db.DBManager;
...
public class EditNoteActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (noteID == -1) {
            //默认添加
            dbManager.addToDB(title, content, time,user);
        } else {
            //更新
            dbManager.updateNote(noteID, title, content, time,user);
        }
